  ...
  return (
    <div className="min-h-screen bg-[#0B0E11] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-40 right-20 w-80 h-80 bg-gradient-to-r from-[#00BFFF]/20 to-[#FFD43B]/20 rounded-full blur-3xl animate-pulse delay-500"></div>
        <div className="absolute bottom-40 left-20 w-96 h-96 bg-gradient-to-l from-[#FFD43B]/15 to-[#18E0FF]/15 rounded-full blur-3xl animate-pulse delay-1500"></div>
        <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] bg-gradient-conic from-[#00BFFF]/8 via-[#FFD43B]/8 to-[#00BFFF]/8 rounded-full blur-3xl animate-spin-slow"></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 relative">
            ...
            <div className="flex justify-center">
              <div className="bg-[#1A1D21]/80 backdrop-blur-xl border border-[#3C4A57]/30 rounded-2xl p-2 inline-flex gap-2 shadow-2xl shadow-[#00BFFF]/10">
                <Button
                  ...
                  className={`px-8 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden ${currentSection === "upcoming"
                      ...
                      : "bg-[#2C3136] text-[#AEB4BB] hover:bg-gradient-to-r hover:from-[#FFD43B]/20 hover:to-[#00BFFF]/20 hover:text-white"
                    }`}
                >
                ...
                <Button
                  ...
                  className={`px-8 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden ${currentSection === "recent"
                      ? "bg-gradient-to-r from-[#00BFFF] to-[#18E0FF] text-[#0B0E11] font-bold shadow-lg shadow-[#00BFFF]/30"
                      : "bg-[#2C3136] text-[#AEB4BB] hover:bg-gradient-to-r hover:from-[#FFD43B]/20 hover:to-[#00BFFF]/20 hover:text-white"
                    }`}
                >
            ...
            <div className="mb-20" key={`featured-${animationKey}`}>
              <div className="flex items-center gap-4 mb-12">
                <div className="p-3 bg-gradient-to-r from-[#FFD43B]/20 to-[#00BFFF]/20 rounded-xl">
                  <Star className="w-6 h-6 text-[#FFD43B]" />
                </div>
                <h3 className="text-4xl font-bold text-white">Featured Events</h3>
                <div className="flex-1 h-px bg-gradient-to-r from-[#FFD43B]/50 to-transparent"></div>
              </div>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {featuredEvents.map((event, index) => {
                  ...
                  return (
                    <Card
                      key={event.id}
                      className="bg-[#1A1D21]/90 backdrop-blur-xl border border-[#3C4A57]/30 hover:border-[#00BFFF]/50 transition-all duration-700 transform hover:scale-[1.02] hover:-translate-y-2 group cursor-pointer overflow-hidden relative shadow-2xl hover:shadow-[#00BFFF]/20"
                    ...
                    >
                      ...
                      <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-[#FFD43B]/0 via-[#00BFFF]/0 to-[#FFD43B]/0 group-hover:from-[#FFD43B]/20 group-hover:via-[#00BFFF]/20 group-hover:to-[#FFD43B]/20 blur-sm transition-all duration-700"></div>
                      ...
                      <div className="relative h-64 overflow-hidden rounded-t-lg">
                        ...
                        <div className="absolute top-6 left-6">
                          <Badge className={`bg-gradient-to-r ${categoryInfo.color} text-[#0B0E11] font-bold px-4 py-2 shadow-lg backdrop-blur-sm`}>
                            {event.category}
                          </Badge>
                        </div>
                        ...
                        <div className="absolute top-6 right-6">
                          <Badge className="bg-gradient-to-r from-[#FFD43B] to-[#FFC300] text-[#0B0E11] font-bold px-4 py-2 shadow-lg backdrop-blur-sm animate-pulse">
                        ...
                        {event.media.some((m) => m.type === "video") && (
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                            <div className="bg-[#FFD43B]/20 backdrop-blur-lg rounded-full p-6 transform group-hover:scale-110 transition-transform duration-300 border border-[#FFD43B]/30">
                              <Play className="w-10 h-10 text-[#FFD43B]" />
                            </div>
                          </div>
                        )}
                        ...
                        <div className="absolute bottom-6 left-6">
                          <div className="bg-[#1A1D21]/90 backdrop-blur-lg rounded-xl px-4 py-2 border border-[#3C4A57]/50">
                            <span className="text-2xl font-bold text-[#FFD43B]">${event.price}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <CardContent className="p-6 relative z-10">
                        <div className="flex items-start justify-between mb-3">
                          <h4 className="text-xl font-bold text-white group-hover:text-[#FFD43B] transition-colors duration-300">
                            {event.title}
                          </h4>
                          <Badge className="bg-[#2C3136]/50 text-[#AEB4BB] px-3 py-1">
                            {event.audience}
                          </Badge>
                        </div>
                        ...
                        <div className="space-y-2 text-sm mb-4">
                          <div className="flex items-center gap-3 text-[#AEB4BB] group-hover:text-white transition-colors duration-300">
                            <div className="p-2 bg-[#2C3136]/50 rounded-lg">
                              <Calendar className="w-4 h-4 text-[#00BFFF]" />
                            </div>
                            <span>{event.date.toLocaleDateString()}</span>
                            <div className="p-2 bg-[#2C3136]/50 rounded-lg ml-4">
                        ...
                        {currentSection === "upcoming" && (
                          <Button
                            ...
                            className={`w-full h-10 bg-gradient-to-r from-[#FFD43B] to-[#FFC300] text-[#0B0E11] font-bold hover:from-[#FFC300] hover:to-[#FFD43B] transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-[#FFD43B]/30 relative overflow-hidden ${hoveredCard === event.id ? 'animate-pulse' : ''
                              }`}
                          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {regularEvents.map((event, index) => {
                ...
                return (
                  <Card
                    key={event.id}
                    className="bg-[#1A1D21]/80 backdrop-blur-xl border border-[#3C4A57]/30 hover:border-[#00BFFF]/50 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 group cursor-pointer overflow-hidden relative shadow-xl hover:shadow-[#00BFFF]/20"
                    onClick={() => openLightbox(event)}
                    onMouseEnter={() => setHoveredCard(event.id)}
                    onMouseLeave={() => setHoveredCard(null)}
                    style={{
                  ...
                  >
                    ...
                    <div className="relative h-60 overflow-hidden rounded-t-lg">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-[#0B0E11]/80 via-transparent to-transparent" />

                      <div className="absolute top-4 left-4">
                        <Badge className={`bg-gradient-to-r ${categoryInfo.color} text-[#0B0E11] font-semibold px-3 py-1 shadow-lg`}>
                          {event.category}
                        </Badge>
                      </div>
                      ...
                      <div className="absolute bottom-4 left-4">
                        <div className="bg-[#1A1D21]/80 backdrop-blur-lg rounded-lg px-3 py-1 border border-[#3C4A57]/50">
                          <span className="text-lg font-bold text-[#FFD43B]">${event.price}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <CardContent className="p-6 relative z-10">
                      <div className="flex items-start justify-between mb-3">
                        <h4 className="text-xl font-bold text-white group-hover:text-[#FFD43B] transition-colors duration-300 line-clamp-1">
                          {event.title}
                        </h4>
                        <Badge className="bg-[#2C3136]/50 text-[#AEB4BB] text-xs px-2 py-1">
                          {event.audience}
                        </Badge>
                      </div>
                      ...
                      <div className="space-y-2 text-xs text-[#AEB4BB] mb-4 group-hover:text-white transition-colors duration-300">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className={`flex items-center gap-1 text-xs ${spotsLeft > 5 ? 'text-[#18E0FF]' : spotsLeft > 0 ? 'text-[#FFD43B]' : 'text-red-500'}`}>
                            <div className={`w-2 h-2 rounded-full ${spotsLeft > 5 ? 'bg-[#18E0FF]' : spotsLeft > 0 ? 'bg-[#FFD43B]' : 'bg-red-500'}`}></div>
                      ...
                      {currentSection === "upcoming" && (
                        <Button
                          ...
                          className={`w-full h-10 bg-gradient-to-r from-[#FFD43B] to-[#FFC300] text-[#0B0E11] font-semibold hover:from-[#FFC300] hover:to-[#FFD43B] transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-[#FFD43B]/30 text-sm relative overflow-hidden ${hoveredCard === event.id ? 'animate-pulse' : ''
                            }`}
                        >
          ...
          <Dialog open={!!selectedEvent} onOpenChange={closeLightbox}>
            <DialogContent className="max-w-6xl bg-[#1A1D21]/95 backdrop-blur-xl border border-[#3C4A57]/30 shadow-2xl shadow-[#00BFFF]/20">
              {selectedEvent && (
                <>
                  <DialogHeader className="border-b border-[#3C4A57]/30 pb-6">
                  ...
                  <div className="space-y-8 pt-6">
                    ...
                    <div className="relative">
                      <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                        {selectedEvent.media[selectedMediaIndex]?.type === "video" ? (
                          <div className="w-full h-full bg-gradient-to-br from-[#2C3136] to-[#1A1D21] flex items-center justify-center rounded-2xl border border-[#3C4A57]/50">
                            <div className="text-center">
                              <div className="bg-gradient-to-r from-[#FFD43B] to-[#00BFFF] p-6 rounded-full mb-4 mx-auto w-fit">
                                <Play className="w-16 h-16 text-[#0B0E11]" />
                              </div>
                        ...
                        {/* Gradient Overlay */}
                        <div className="absolute inset-0 bg-gradient-to-t from-[#0B0E11]/20 via-transparent to-transparent rounded-2xl"></div>
                      </div>
                      ...
                      {selectedEvent.media.length > 1 && (
                        <>
                          <Button
                            ...
                            className="absolute left-4 top-1/2 -translate-y-1/2 bg-[#1A1D21]/90 backdrop-blur-xl border border-[#3C4A57]/50 hover:border-[#00BFFF]/50 text-white hover:bg-[#2C3136] rounded-full p-3 shadow-xl"
                          >
                          ...
                          <Button
                            ...
                            className="absolute right-4 top-1/2 -translate-y-1/2 bg-[#1A1D21]/90 backdrop-blur-xl border border-[#3C4A57]/50 hover:border-[#00BFFF]/50 text-white hover:bg-[#2C3136] rounded-full p-3 shadow-xl"
                          >
                            <ChevronRight className="w-5 h-5" />
                          </Button>
                          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 bg-[#1A1D21]/80 backdrop-blur-xl rounded-full p-2 border border-[#3C4A57]/50">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center gap-4 p-4 bg-[#2C3136]/50 rounded-xl backdrop-blur-sm border border-[#3C4A57]/30">
                            <div className="p-3 bg-gradient-to-r from-[#FFD43B]/20 to-[#00BFFF]/20 rounded-xl">
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center justify-between mb-6">
                          {(() => {
                            ...
                            return (
                              <Badge className={`bg-gradient-to-r ${categoryInfo.color} text-[#0B0E11] font-bold px-4 py-2 text-lg`}>
                                {selectedEvent.category}
                              </Badge>
                            )
                          })()}
                          <Badge className="bg-[#2C3136]/50 text-[#AEB4BB] px-4 py-2 text-lg border border-[#3C4A57]/50">
                            {selectedEvent.audience}
                          </Badge>
                        </div>

                        <div className="space-y-4">
                          <div className="flex justify-between items-center p-4 bg-[#2C3136]/50 rounded-xl backdrop-blur-sm border border-[#3C4A57]/30">
                        ...
                        {currentSection === "upcoming" && (
                          <Button
                            ...
                            className="w-full h-16 bg-gradient-to-r from-[#FFD43B] to-[#FFC300] text-[#0B0E11] font-bold hover:from-[#FFC300] hover:to-[#FFD43B] transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-[#FFD43B]/40 text-xl rounded-xl relative overflow-hidden"
                          >
                    ...
                    {selectedEvent.media[selectedMediaIndex]?.caption && (
                      <div className="text-center bg-[#2C3136]/30 rounded-xl p-6 border border-[#3C4A57]/30">
